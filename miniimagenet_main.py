...
def parse_args():
    ...
    parser.add_argument('--arch', '-a', type=str, metavar='ARCH',
                        choices=['alexnet', 'vgg16', 'omniglotcnn', 'miniimagenetcnn'], default='miniimagenetcnn')
    ...
    parser.add_argument('--sample_per_task', type=int, default=128)
...
def main(args):
    ...
    # load the data
    tra = transforms.Compose([transforms.Resize((84, 84)),
                              transforms.ToTensor(),
    ...
    for epoch in tqdm(range(args.epochs)):
        ...
        if epoch % 1000 == 0 and epoch != 0:
            ...
            }, './output/checkpoint/miniimagenet_' + str(args.epoch) + '.pth')
